...
val logger = LoggerFactory.getLogger("convert_vcf_adam_dataset")
...
val genotypes = sc.loadVcf(inputPath.get).toGenotypes
genotypes.transformDataset(ds => ds).saveAsParquet(outputPath.get)
