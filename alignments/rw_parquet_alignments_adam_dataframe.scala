...
val logger = LoggerFactory.getLogger("rw_parquet_alignments_adam_dataframe")
...
val alignments = sc.loadAlignments(df, inputPath.get)

alignments.toDF.write.parquet(outputPath.get)
alignments.saveMetadata(outputPath.get)
