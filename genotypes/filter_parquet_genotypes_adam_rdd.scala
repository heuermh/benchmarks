...
val logger = LoggerFactory.getLogger("filter_parquet_genotypes_adam_rdd")
...
val genotypes = sc.loadParquetGenotypes(inputPath.get, optPredicate, optProjection)
println(genotypes.rdd.count())
