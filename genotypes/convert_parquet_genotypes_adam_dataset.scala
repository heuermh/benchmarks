...
val logger = LoggerFactory.getLogger("convert_parquet_genotypes_adam_dataset")
...
genotypes.transformDataset(ds => ds).toVariantContexts().saveAsVcf(outputPath.get, asSingleFile = true)
