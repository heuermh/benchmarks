...
val logger = LoggerFactory.getLogger("rw_parquet_genotypes_adam_dataframe")
...
val genotypes = sc.loadGenotypes(df, inputPath.get)

genotypes.toDF.write.parquet(outputPath.get)
genotypes.saveMetadata(outputPath.get)
