...
val logger = LoggerFactory.getLogger("range_filter_parquet_alignments_adam_partitioned_dataset")
...
val alignments = sc.loadPartitionedParquetAlignments(inputPath.get, ranges)
