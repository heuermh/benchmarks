...
val logger = LoggerFactory.getLogger("range_filter_parquet_variants_adam_partitioned_dataset")
...
val variants = sc.loadPartitionedParquetVariants(inputPath.get, ranges)
println(variants.dataset.count())
